...
-- NOTE: Quickfix navigation
vim.keymap.set('n', '<leader>j', '<cmd>cnext<return>')
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --
        -- Working Vue Config: https://github.com/mason-org/mason-lspconfig.nvim/issues/371#issuecomment-2249935162
        volar = {
